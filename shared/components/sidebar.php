...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="nav-list primary-nav">
            ...
            <li class="nav-item sidebar-item" data-controller="admin" id="fetch_services"><a href="#" class="nav-link"><span class="material-symbols-rounded">church</span><span class="nav-label">Services</span></a></li>
